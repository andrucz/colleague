...
import static com.andrucz.colleague.Checks.checkPosition;
...
public final class Colleague {
	...
	public static <E> void each(Collection<E> elements, Predicate<E> predicate, Operation<E> operation)
	...
	public static <E, R> List<R> convert(Collection<E> elements, Predicate<E> predicate,
			ElementConverter<E, R> converter) {
		checkNotNull(predicate, "predicate");
