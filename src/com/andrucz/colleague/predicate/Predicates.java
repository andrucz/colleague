...
import com.andrucz.colleague.predicate.comparable.BetweenPredicate;
import com.andrucz.colleague.predicate.comparable.EqualsToPredicate;
import com.andrucz.colleague.predicate.comparable.GreaterThanPredicate;
import com.andrucz.colleague.predicate.comparable.LessThanPredicate;
import com.andrucz.colleague.predicate.composite.AcceptCountPredicate;
import com.andrucz.colleague.predicate.composite.AnyPredicate;
import com.andrucz.colleague.predicate.composite.EveryPredicate;
import com.andrucz.colleague.predicate.string.ContainsPredicate;
import com.andrucz.colleague.predicate.string.EndsWithPredicate;
import com.andrucz.colleague.predicate.string.LowerCasePredicate;
import com.andrucz.colleague.predicate.string.StartsWithPredicate;
import com.andrucz.colleague.predicate.string.UpperCasePredicate;
